...
public class BOSS3rd : MonoBehaviour {
	private int ID=3;
	...
	void Start () {
		...
		Vector3 tempp;
		tempp=Vector3Tool.Parse(read.OnFind("bossDate", "3", "coordinate"));
		...
		ontime=int.Parse(read.OnFind("bossDate", "3", "time"));
		speedx = float.Parse (read.OnFind("bossDate", "3", "speedx"));
		speedy = float.Parse (read.OnFind("bossDate", "3", "speedy"));
		yup=float.Parse (read.OnFind("bossDate", "3", "yup"));
		ydown=float.Parse (read.OnFind("bossDate", "3", "ydown"));
		biux=float.Parse (read.OnFind("bossDate", "3", "biux"));
		biuy=float.Parse (read.OnFind("bossDate", "3", "biuy"));
		staticlaserx=float.Parse (read.OnFind("bossDate", "3", "staticlaserx"));
		staticlasery=float.Parse (read.OnFind("bossDate", "3", "staticlasery"));
	}
